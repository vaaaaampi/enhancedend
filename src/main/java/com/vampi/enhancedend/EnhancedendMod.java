...
import com.vampi.enhancedend.init.EnhancedendModTabs;
import com.vampi.enhancedend.init.EnhancedendModItems;
import com.vampi.enhancedend.init.EnhancedendModBlocks;

@Mod("enhancedend")
public class EnhancedendMod {
	public static final Logger LOGGER = LogManager.getLogger(EnhancedendMod.class);
	public static final String MODID = "enhancedend";

	public EnhancedendMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		EnhancedendModBlocks.REGISTRY.register(modEventBus);
		EnhancedendModItems.REGISTRY.register(modEventBus);
		EnhancedendModTabs.REGISTRY.register(modEventBus);
